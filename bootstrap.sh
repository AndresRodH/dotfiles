...
echo "  3. Herdr: herdr integration install opencode && npx skills add ogulcancelik/herdr --skill herdr -g -y"
echo "  4. Open Neovim and let LazyVim install plugins"
echo "  5. Rebuild bat cache: bat cache --build"
echo ""
if [ -d "$BACKUP_DIR" ]; then
